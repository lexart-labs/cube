const translations = {
  es: {
    dashboard: {
      ...
      manageCandidates: 'Gestión de candidatos',
      ...
      portugueseLevel: 'Nivel de portugués',
      levelNone: 'Ninguno',
      levelBasic: 'Básico',
      ...
      candidateDeleted: 'Candidato eliminado exitosamente',
      confirmDelete: '¿Está seguro que desea eliminar este candidato?',
			selectPosition: 'Seleccione una posición',
			selectSource: 'Seleccione una plataforma',
  ...
  en: {
    dashboard: {
      ...
      manageCandidates: 'Candidate Management',
      fullName: 'Full Name',
      email: 'Email',
      country: 'Country',
      phone: 'Phone',
    ...
    positionAssignments: {
      ...
      'Lead Software Architect': [
        ...
        'Construction of BackEnd / FrontEnd / Base of datos desde 0.',
        'Planificación de contingencia y control de riesgos',
      ...
      'Solution Architect': [
        ...
        'Ability to transmit technology needs to unsuitable personnel in the matter (Comercial, Marketing, etc)',
